...
- (void)scene:(UIScene *)scene willConnectToSession:(UISceneSession *)session options:(UISceneConnectionOptions *)connectionOptions {
    ...
    VSSearchViewController *masterViewController = (VSSearchViewController *)masterNavigationController.topViewController;
    UINavigationController *navigationController = [splitViewController.viewControllers lastObject];
    VSDetailsViewController *detailsViewController = (VSDetailsViewController *)navigationController.topViewController;
